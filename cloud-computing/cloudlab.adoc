...
* For Configure Security Group, set up a 3400 Security Group. This group will give you the ability to run HTTP, SSH, and Ping traffic. Then click Review and Launch
