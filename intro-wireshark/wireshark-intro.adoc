...
** What is anything you might recognize here?
...
** Again, can you make any sense of what is going on? 
...
* Apply a new filter by typing `http.request == 1`. This will get you all of the packets in your capture that contain an HTTP REQUEST (if you have any!)
...
During the packet capture, you should have run the `ping` command to send several pings to some computer the server at www.google.com. Now we'll find those pings to see what they look like at the packet level.
...
== Questions (You don't have to answer these for the assignment)

=== Quick questions (You don't have to answer but may end up on the exam)
...
=== Do some research or thinking (Extra Work Not Required for the Assignment)
[start=7]
