...
.AWS Account
image::screenshot_0.jpg[AWS Account]

{nbsp} +

In this next screen, simply click on Learner Lab course [127396 course]. 

.Modules
image::Screenshot_1.jpg[Modules]
...
## Sample Technologies in AWS - Let's take a look at 4 popular ones (EC2, Lambda, RDS, DynamoDB)
{nbsp} +
EC2
{nbsp} +
...
Pick three more applications that strike your fancy and explore them. Do a one - two paragraph write up of these components with screenshots.
