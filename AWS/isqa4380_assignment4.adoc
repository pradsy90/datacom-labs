...
E). I can call all of these above as middlewares which you can use to build distributed applications. Would you agree? Pick about 6 more of these applications in addition to the 4 listed above and describe how you think they can act as an middleware for a distributed application.
...
- Follow the rubrik's cube so you know what to discuss to get full points
